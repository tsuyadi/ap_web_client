...
class SpcModal extends React.Component {
   ...
   constructor(props){
    ...
    downloadModalSelling(){
        ...
        $.ajax({
            ...
            success: (response) => {
                ...
                FileSaver.saveAs(blob, "Prospect Card Selling" + localStorage.agent_code + ".xlsx");
            },
            error: (err, response) => {
                $('#loading').modal('hide');
    ...
    render()
    {
        ...
        return(
            <div className="modal fade spc-modal" id="spc-modal" tabIndex="-1" role="dialog" aria-labelledby="spc-modalLabel" aria-hidden="true">
                  ...
                  <div className="table-responsive" >
                      <table className="table table-bordered table-striped table-hover table-box" id="spc-table" height="100%">
                          ...
                          <tbody id="spc-body">   
                            ...
                            <tfoot>
                                <tr>
                                    <th colSpan="15"><button style={{marginRight:'10px'}} className="btn btn-primary"  onClick={() => this.downloadModalSelling()}>Download Prospect Card</button><button className="btn btn-primary" >Download M.O.N.E.Y Analysis</button></th>
                                </tr>
                            </tfoot>
                      </table>
                        <div>
