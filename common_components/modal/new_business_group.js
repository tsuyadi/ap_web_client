...
class NewBusinessModal extends React.Component {
	...
	_onSortChange(columnKey, sortDir) {
		var sortIndexes = this.state.filteredData;
	...
	render(){
		...
		this.state.data.map(function(item) {
			...
			let notes_br = notes.replace("[NB]","[ NB]");
			notes_br = notes_br.replace(/\[NB\]/g,"<br>*[NB]");
		...
		*/}
							...
							<div className="row">
								<div className="col-sm-12">
									<div class="panel panel-default">
										<div id={"collapsegroup" + item.no} className="dialog-collapse collapse" role="tabpanel" aria-labelledby={"heading" + item.no}>
											<div class="panel-body">
												...
												<div className="row">
													<div className="col-xs-3">
														<div className="col-title">SPAJ Notes</div>
													</div>
													<div className="col-xs-9">
														<div className="col-content">{clean_notes}</div>
													</div>
												</div>
											</div>
										</div>
										<div class="panel-heading" role="tab" id="headingOne">
											<div className="more-detail">
												<a className="btn btn-block btn-default" role="button" data-toggle="collapse" data-parent="#accordion" href={"#collapsegroup" + item.no} aria-expanded="false" aria-controls={"collapse" + item.no}>
													Detail
												</a>
											</div>
										</div>
		...
		var t_width = this.props.statusSPAJ == 'pending' ? 1600 : 1200;

		/** Modif End Here */

		return (
        <div className="modal fade newbusinessSummary" id="newbusinessgroup" tabIndex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
