...
class MenuComission extends React.Component {
	constructor(props){
		super(props);
		this.state = {
			mgtRole : [1,2,3,4],
	...
	render(){
		...
		}else if(this.state.dashboardMaps[userrole] == 'fc'){
			memoMenu.push(
				<ul>
					...
					<li><a href="#/newbusiness" title="New Business"><i className="fa fa-suitcase"></i> {LoadLabel('Inquiry')}</a></li>
