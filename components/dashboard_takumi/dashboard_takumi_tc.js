...
import PersonalOveridding from './personal_overidding';
...
import VideoDashboard from '../dashboard_v2/video_dashboard';
...
import BannerDashboardTakumi from './banner_dashboard_takumi';
class dashboard_takumi_tc extends React.Component {
	constructor(props){
		super(props);
   ...
   showRight = (event) => {
	...
	// getDataGroup(){
	// 	$.ajax({
	// 		url: api_route.dashboard+'?group=1',
	// 		headers: {
	// 			'Authorization':'JWT '+sessionStorage.getItem('token')
	// 		},
	// 		data: {
						...
						<div className="tab-content">
							...
							<div role="tabpanel" className="tab-pane active" id="personalselling">
								<div className="topWidget">
									...
									<div className="row">
										<div className="col-xs-4 responsive3" style={(localStorage.getItem('role')==15 || localStorage.getItem('role')==16) ? {} :{display:'none'}}>
											<PersonalOveridding data={this.state.data && this.state.data} />
										</div>
										<div className={(localStorage.getItem('role')==15 || localStorage.getItem('role')==16) ? 'col-xs-4 responsive3' :'col-xs-6 responsive3'}>
											<PersonalPersistency data={this.state.data && this.state.data} />
										</div>

										<div className={(localStorage.getItem('role')==15 || localStorage.getItem('role')==16) ? 'col-xs-4 responsive3' :'col-xs-6 responsive3'}>
											<IssuranceRatio data={this.state.data} />
										</div>
									</div>
...
export default dashboard_takumi_tc;
