...
class PremiumCaseGroup extends React.Component {
	constructor(props){
		super(props);
	this.state = {
			data : null
	...
	render(){
        var ape_wtd =  parseInt(this.state.data && this.state.data.takumi_dashboard_group.ape_wtd);
        var ape_mtd =  parseInt(this.state.data && this.state.data.takumi_dashboard_group.ape_mtd);
        var ape_ytd =  this.state.data && this.state.data.takumi_dashboard_group.ape_ytd != null ? this.state.data && this.state.data.takumi_dashboard_group.ape_ytd : 0;
        // var ap_wtd =  parseInt(this.state.data && this.state.data.takumi_dashboard_group.ap_wtd);
        // var ap_mtd =  parseInt(this.state.data && this.state.data.takumi_dashboard_group.ap_mtd);
        // var ap_ytd =  parseInt(this.state.data && this.state.data.takumi_dashboard_group.ap_ytd);
        var fyp_wtd =  parseInt(this.state.data && this.state.data.takumi_dashboard_group.fyp_wtd);
        var fyp_mtd =  parseInt(this.state.data && this.state.data.takumi_dashboard_group.fyp_mtd);
        var fyp_ytd =  parseInt(this.state.data && this.state.data.takumi_dashboard_group.fyp_ytd);
        ...
        var ec_submit_wtd =  this.state.data && this.state.data.takumi_dashboard_group.ec_submit_wtd;
        var ec_submit_mtd =  this.state.data && this.state.data.takumi_dashboard_group.ec_submit_mtd;
        var ec_submit_m6 =  this.state.data && this.state.data.takumi_dashboard_group.ec_submit_six_previous_month;
        var ec_submit_ytd =  this.state.data && this.state.data.takumi_dashboard_group.ec_submit_ytd;
        var ec_issued_wtd =  this.state.data && this.state.data.takumi_dashboard_group.ec_issued_wtd;
        var ec_issued_mtd =  this.state.data && this.state.data.takumi_dashboard_group.ec_issued_mtd;
        var ec_issued_m6 =  this.state.data && this.state.data.takumi_dashboard_group.ec_issued_six_previous_month;
        var ec_issued_ytd =  this.state.data && this.state.data.takumi_dashboard_group.ec_issued_ytd;
        ...
        var fyc_wtd =  parseInt(this.state.data && this.state.data.takumi_dashboard_group.fyc_wtd);
        var fyc_mtd =  parseInt(this.state.data && this.state.data.takumi_dashboard_group.fyc_mtd);
        var fyc_ytd =  parseInt(this.state.data && this.state.data.takumi_dashboard_group.fyc_ytd);
        var syc_wtd =  parseInt(this.state.data && this.state.data.takumi_dashboard_group.syc_wtd);
        var syc_mtd =  parseInt(this.state.data && this.state.data.takumi_dashboard_group.syc_mtd);
        var syc_ytd =  parseInt(this.state.data && this.state.data.takumi_dashboard_group.syc_ytd);
                        ...
                        <div className="box-summary" style={{height : '88%'}}>
                            <div className="tab-mobile hidden-md hidden-lg">
                                <ul className="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation"><a href="#c_ytd" aria-controls="c_m6" role="tab" data-toggle="tab">Last 6 Month</a></li>
...
export default PremiumCaseGroup;