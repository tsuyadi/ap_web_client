...
class BannerDashboardTakumi extends React.Component {
            ...
            this.state.data.map((value, index) => {
                if(index == 0){
                    ...
                    <div className="item active" style={{height:'550px'}} key={index}>
                        <img className="img-responsive" src={api_route.baseAPI+value.image} alt={value.description} style={{display:'block', margin: 'auto', left:0, right:0, top:0, bottom:0, 'text-align': 'center',height: '550px'}}/>
                    </div>);
...
export default BannerDashboardTakumi;