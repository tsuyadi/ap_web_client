...
class ProductionSummary extends React.Component {
      ...
      _sorting(data, content, type){
        if(content == "total_annualize"){
          ...
          if(type == SortType.ASC){
            data.sort(function(a, b){
              return a.maapr - b.maapr;
            });
          }else{
            data.sort(function(a, b){
              return b.maapr - a.maapr;
            });
          }
        }else if(content == "fyp"){
          if(type == SortType.ASC){
        ...
        }else if(content == "average_policy"){
          if(type == SortType.ASC){
            data.sort(function(a, b){
              return a.average_policy - b.average_policy;
            });
          }else{
            data.sort(function(a, b){
              return b.average_policy - a.average_policy;
            });
          }
        }else if(content == "rider_ratio"){
          if(type == SortType.ASC){
            data.sort(function(a, b){
              return a.rider_ratio - b.rider_ratio;
            });
          }else{
            data.sort(function(a, b){
              return b.rider_ratio - a.rider_ratio;
            });
          }
        }
        return data;
      ...
      _onFilterChange(cellDataKey, event){
        ...
        var size = this.state.rd_child && this.state.rd_child.length;
        var filteredList = [];
        ...
        if(this.state.filterd_data && this.state.filterd_data.length > 0){
        ...
        dataUsed.map((response, item) => {
          mobileVersion.push(
            <div key={response.agent_code} className="row row-table">
              <div className="col-sm-12">
                <div className="row ">
                  <div className="col-xs-3">
                    <div className="col-title">Production Report</div>
                  </div>
                  <div className="col-xs-9">
                    <div className="col-content">
                    { localStorage.getItem('role') != 4 ?
                      <a href={api_route.production_report_agent + response.agent_id + '/?detail=1&token='+sessionStorage.getItem('token')}>
                        <button className="btn btn-default"><i className="fa fa-download"></i></button>
                      </a> : ''
                    }
                    </div>
                  </div>
                ...
                <div className="row ">
                  ...
                  <div className="col-xs-9">
                    <div className="col-content">{response.agent_code != null ? response.agent_code : '-'}</div>
                  </div>
                </div>						
                <div className="row ">
                  <div className="col-xs-3">
                  ...
                  <div className="col-xs-9">
                    <div className="col-content">{response.partner != null ? response.partner : '-'}</div>
                  </div>
                </div>
                <div className="row ">
                  <div className="col-xs-3">
                  ...
                  <div className="col-xs-9">
                    <div className="col-content">{response.cases != null ? response.cases : '-'}</div>
                  </div>
                </div>
                <div className="row ">
                  <div className="col-xs-3">
                  ...
                  <div className="col-xs-9">
                    <div className="col-content">{response.total_annualized_premium != null ? MoneyFormat(response.total_annualized_premium) : '0'}</div>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-sm-12">
                    <div class="panel panel-default">
                      <div id={"collapse" + response.agent_code} className="dialog-collapse collapse" role="tabpanel" aria-labelledby={"heading" + item.no}>
                        <div class="panel-body">
                          <div className="row ">
                            ...
                            <div className="col-xs-9">
                              <div className="col-content">{response.qc != null ? response.qc : '-'}</div>
                            </div>
                          </div>
                          {/*
                           RD Code, RD Name, Case, Total APE, Qualified Case, Active Agent, Registered Agent, Activity Ratio, MAPR, MAAPR, Total Collected Premium
                          */}
                          <div className="row ">
                            ...
                            <div className="col-xs-9">
                              <div className="col-content">{response.active_agent != null ? response.active_agent : '-'}</div>
                            </div>
                          </div>
                          <div className="row ">
                            <div className="col-xs-3">
                            ...
                            <div className="col-xs-9">
                              <div className="col-content">{response.registered_agent != null ? response.registered_agent : '-'}</div>
                            </div>
                          </div>
                          <div className="row ">
                            <div className="col-xs-3">
                            ...
                            <div className="col-xs-9">
                              <div className="col-content">{response.activity_ratio != null ? response.activity_ratio : '-'} % </div>
                            </div>
                          </div>
                          <div className="row ">
                            <div className="col-xs-3">
                            ...
                            <div className="col-xs-9">
                              <div className="col-content">{response.mapr != null ? decimalFormatCeilling(response.mapr) : 0}</div>
                            </div>
                          </div>
                          <div className="row ">
                            <div className="col-xs-3">
                            ...
                            <div className="col-xs-9">
                              <div className="col-content">{response.maapr != null ? decimalFormatCeilling(response.maapr) : 0}</div>
                            </div>
                          </div>
                          <div className="row ">
                            <div className="col-xs-3">
                            ...
                            <div className="col-xs-9">
                              <div className="col-content">{response.grand_total_collected_premium != null ? MoneyFormat(response.grand_total_collected_premium) : '0'}</div>
                            </div>
                          </div>
                          <div className="row ">
                            <div className="col-xs-3">
                              <div className="col-title">Average Policy Size</div>
                            </div>
                            <div className="col-xs-9">
                              <div className="col-content">{response.average_policy != null ? MoneyFormat(response.average_policy) : '0'}</div>
                            </div>
                          </div>
                          <div className="row ">
                            <div className="col-xs-3">
                              <div className="col-title">Rider Ratio Attachment</div>
                            </div>
                            <div className="col-xs-9">
                              <div className="col-content">{response.rider_ratio != null ? response.rider_ratio : '0'}</div>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="panel-heading" role="tab" id="headingOne">
                        <div className="more-detail">
                          <a className="btn btn-block btn-default" role="button" data-toggle="collapse" data-parent="#accordion" href={"#collapse" + response.agent_code} aria-expanded="false" aria-controls={"collapse" + item.no}>
                            Detail
                          </a>
                        </div>
                      </div>
        ...
        if(true){
          /*downloadPr.push(
            <div>
              <a style={{'margin-right':'10px'}} href={this.state.data && api_route.production_report_management + '?year=2016'}>
          ...
          downloadPr.push(
            <div>
              <a style={{'margin-right':'10px'}} href={this.state.data && api_route.production_report_management + '?year=2016&uid=' + uid +'&'+token}>
                <button className="btn btn-warning"><i className="fa fa-download"></i> Download Production Report 2016</button>
              </a>	
               <a style={{'margin-right':'10px'}} href={this.state.data && api_route.production_report_management + '?year=2017&uid=' + uid +'&'+ token}>
                <button className="btn btn-warning"><i className="fa fa-download"></i> Download Production Report 2017</button>
              </a>	
              <a style={{'margin-right':'10px'}} href={this.state.data && api_route.production_report_management + '?year=2018&uid=' + uid +'&'+ token}>
                <button className="btn btn-warning"><i className="fa fa-download"></i> Download Production Report 2018</button>
              </a>	
              <a style={{'margin-right':'10px'}} href={this.state.data && api_route.production_report_management + '?year=2019&uid=' + uid +'&'+ token}>
                <button className="btn btn-warning"><i className="fa fa-download"></i> Download Production Report 2019</button>
              </a>	
              <a style={{'margin-right':'10px', display:'none'}} href={this.state.data && api_route.movement_report_management + '?' + token}>
                <button className="btn btn-warning"><i className="fa fa-download"></i>  Download Movement Report All RD</button>
              </a>
              {/*<a style={{'margin-right':'10px'}} href={this.state.data && api_route.movement_report_management_ash + '?' + token}>
                <button className="btn btn-warning"><i className="fa fa-download"></i>  Download Movement Report All ASH</button>
              </a>	*/}
              {/*<a target="_blank" href={this.state.data && api_route.new_recruit_report_management + '?' + token}>
                <button className="btn btn-warning"><i className="fa fa-download"></i> Download New Recruit Report</button>
              </a>*/}
            </div>
          );
        }
                    ...
                    <div className="row row-table-header hidden">
                      ...
                      <div className="col-sm-12">
                        <select className="form-control" onChange={this._changeFilterOption}>
                          ...
                          <option value="spaj_number">RD Code</option>
                    ...
                    <table className="table table-striped table-bordered table-box ">  
                      <thead className="noselect">
                        <tr key="header_productsummary">
                          <th className="text-center header_table"  style={(localStorage.getItem('role') == 4) ? {'textAlign':'right'} : {'textAlign':'right'}}></th>
                          <th className="text-center header_table"><a onClick={this.itemSorting.bind(this, "agent_code")}>RD Code</a></th>
                          ...
                          <th className="header_table"><a onClick={this.itemSorting.bind(this, "qualify_case")}>Validated Case</a> {this.sortIcon("qualify_case")}</th>
                          <th className="header_table"><a onClick={this.itemSorting.bind(this, "active_agent")}>Validated Active Agent</a> {this.sortIcon("active_agent")}</th>
                          ...
                          {/* <th className="header_table" style={(localStorage.getItem('role') == 4) ? {display:'none'} : {'textAlign':'right'}}><a onClick={this.itemSorting.bind(this, "fyp")}>NBU Coll Premium (FYP BPR + RTU)</a> {this.sortIcon("fyp")}</th>
                          <th className="header_table" style={(localStorage.getItem('role') == 4) ? {display:'none'} : {'textAlign':'right'}}><a onClick={this.itemSorting.bind(this, "grand_total")}>Total Collected Premium</a> {this.sortIcon("grand_total")}</th>
                          <th className="header_table" style={(localStorage.getItem('role') == 4) ? {display:'none'} : {'textAlign':'right'}}><a onClick={this.itemSorting.bind(this, "average_policy")}>Average Policy Size</a> {this.sortIcon("average_policy")}</th>
                          <th className="header_table" style={(localStorage.getItem('role') == 4) ? {display:'none'} : {'textAlign':'right'}}><a onClick={this.itemSorting.bind(this, "rider_ratio")}>Rider Ratio Attachment</a> {this.sortIcon("rider_ratio")}</th> */}
                        </tr>
                        <tr key="header_productsummary_filter">
                          ...
                          {/* <th className="header_table" style={(localStorage.getItem('role') == 4) ? {display:'none'} : {'textAlign':'right'}}><input type="text" name="fyp" onChange={this._onFilterChange.bind(this, "fyp")} className="form-control" /></th>
                          <th className="header_table" style={(localStorage.getItem('role') == 4) ? {display:'none'} : {'textAlign':'right'}}><input type="text" name="grand_total_collected_premium" onChange={this._onFilterChange.bind(this, "grand_total_collected_premium")} className="form-control" /></th>
                          <th className="header_table" style={(localStorage.getItem('role') == 4) ? {display:'none'} : {'textAlign':'right'}}><input type="text" name="average_policy" onChange={this._onFilterChange.bind(this, "average_policy")} className="form-control" /></th>
                          <th className="header_table" style={(localStorage.getItem('role') == 4) ? {display:'none'} : {'textAlign':'right'}}><input type="text" name="rider_ratio" onChange={this._onFilterChange.bind(this, "rider_ratio")} className="form-control" /></th> */}
                        </tr>
                      </thead>
                      <tbody>
                        {
                            ...
                            // {
                                ...
                                return (
                                  <tr key={item.agent_code}>
                                    <td style={(localStorage.getItem('role') == 4) ? {} : {}}>
                                      <a href={api_route.production_report_agent + item.agent_id + '/?detail=1&token='+sessionStorage.getItem('token')}>
                                        <button className="btn btn-default"><i className="fa fa-download"></i></button>
                                      </a>
                                    </td>
                                    <td className="text-center">{item.agent_code}</td>
                                    <td>{item.partner}</td>
                                    <td>{item.cases}</td>
                                    ...
                                    {/* <td  style={(localStorage.getItem('role') == 4) ? {display:'none'} : {'textAlign':'right'}}>{MoneyFormat(item.fyp)}</td>
                                    <td  style={(localStorage.getItem('role') == 4) ? {display:'none'} : {'textAlign':'right'}}>{MoneyFormat(item.grand_total_collected_premium)}</td>
                                    <td  style={(localStorage.getItem('role') == 4) ? {display:'none'} : {'textAlign':'right'}}>{MoneyFormat(item.average_policy)}</td>
                                    <td  style={(localStorage.getItem('role') == 4) ? {display:'none'} : {'textAlign':'right'}}>{item.rider_ratio}</td> */}
                                  </tr>
                                );
                        ...
                        <tr key="header_productsummary_paging">
                          <td className="paging-table" colSpan={13}>
                            { /*
