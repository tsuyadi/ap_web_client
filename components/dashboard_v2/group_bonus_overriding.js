...
class GroupBonusOverriding extends React.Component {
	constructor(props){
		super(props);
	}
	...
	render(){
        ...
        <div className="wrapContent">
			<div className="subtitle"><i className="fa fa-calculator"></i> Bonus Overriding [Month - Year]</div>
			<div className="entry">
				<div className="col-xs-6">
					...
					<div className="periode">Period : [{this.state.data && this.state.data.specific_data.income_calculation.bonus_overriding.period.start_date.substring(0,10)} - {this.state.data && this.state.data.specific_data.income_calculation.bonus_overriding.period.end_date.substring(0,10)}]</div>
				</div>
				...
				<div className="row">
					<div className="col-xs-5 responsive2">
						...
						<label className="col-xs-5">Bonus Overriding from Direct SM:</label>
						<div className="col-xs-7">
							<span className="red">Rp {this.state.data && MoneyFormat(this.state.data.specific_data.income_calculation.bonus_overriding.bo_direct_sm)}</span>
						</div>
					</div>
					...
					<div className="col-xs-7 responsive2">
						...
						<table className="table table-bordered table-striped">
							<thead>
								<tr>
									<th>Week</th>
									<th>Bonus OR Direct FC</th>
									<th>Bonus OR Direct SM</th>
									<th>Total</th>
								</tr>
							</thead>
							<tbody>
...
export default GroupBonusOverriding;