...
class GroupOverriding extends React.Component {
	constructor(props){
		super(props);
	...
	render(){
        ...
        <div className="wrapContent boxShadow">
			...
			<div className="subfooter">
				Tingkat overriding mingguan Anda adalah Rp <span className="blink">{MoneyFormat(total_or)}</span>. Batas akhir issued case untuk team anda minggu ini adalah {DateFormatCustom(end_date, -1)}
			</div>
		</div>
		);
	}
...
export default GroupOverriding;