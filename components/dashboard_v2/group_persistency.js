...
class GroupPersistency extends React.Component {
	...
	handleShowModal(p){
		if(p == 1 )
		{
			let ecp = this.state.data.specific_data.group_persistency.group_p1.ecp_p1;
			let acp = this.state.data.specific_data.group_persistency.group_p1.acp_p1;
			this.setState({
		...
		{
			let ecp = this.state.data.specific_data.group_persistency.group_p2.ecp_p2;
			let acp = this.state.data.specific_data.group_persistency.group_p2.acp_p2;
			this.setState({
	...
	render(){
		...
		var pg1 = this.state.data && this.state.data.specific_data.group_persistency.group_p1.p1;
		var pg2 = this.state.data && this.state.data.specific_data.group_persistency.group_p2.p2;
		...
		if(data_pg1.length > 0)
		{
			chart_pg1.push(
				<ResponsiveContainer>
					{/*<PieChart onMouseEnter={this.onPieEnterPG1}>*/}
					<PieChart>
						<Pie 
		...
		if(data_pg2.length > 0)
		{
			chart_pg2.push(
				<ResponsiveContainer>
					{/*<PieChart onMouseEnter={this.onPieEnterPG2}>*/}
					<PieChart>
						<Pie 
		...
		let ecp_p1 = this.state.data != null ? this.state.data.specific_data.group_persistency.group_p1.ecp_p1 : 0;
		let acp_p1 = this.state.data != null ? this.state.data.specific_data.group_persistency.group_p1.acp_p1 : 0;
		ecp_p1 = MoneyFormat(ecp_p1);
		acp_p1 = MoneyFormat(acp_p1);

		let ecp_p2 = this.state.data != null ? this.state.data.specific_data.group_persistency.group_p2.ecp_p2 : 0;
		let acp_p2 = this.state.data != null ? this.state.data.specific_data.group_persistency.group_p2.acp_p2 : 0;
