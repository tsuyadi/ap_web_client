...
import GroupRmOverriding from './group_rm_overriding';
import GroupRmParalllelOverriding from './group_rm_parallel_overriding';
import GroupRmBonusOverriding from './group_rm_bonus_overriding';
...
class dashboard_rm extends React.Component {
	constructor(props){
		super(props);
		this.state = {
			data: null,
