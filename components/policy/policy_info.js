...
//import StatusPolicy from '../../common_components/modal/status_policy_info';
...
class policy_info extends React.Component {
  ...
  componentDidMount(){
    ...
    if(data){
		...
		if (data && data.components != undefined && data.components.length > 0){
			components.map((d, e) => {
				// // debugger;
		...
		let components_lr = data.components_lr;
		
		if (data && data.components_lr != undefined && data.components_lr.length > 0){
			components_lr.map((d, e) => {
				// // debugger;
				var cov_start = d.coverage_start == '1900-01-01' ? '' : d.coverage_start;
				var cov_end = d.coverage_end == '1900-01-01' ? '' : d.coverage_end;
		...
		let hsr_info = data.hsr_info;
		if (data && data.hsr_info && data.hsr_info.length > 0){
			hsr_info.map((d, e) => {
				// // debugger;
				var cov_start = d.coverage_start == '1900-01-01' ? '' : d.coverage_start;
				var cov_end = d.coverage_end == '1900-01-01' ? '' : d.coverage_end;
			...
			<div className="main-wrapper">
				...
				*/}
				<div className="main twoColumnMain">
					...
					<LeftMenuPolicy active="0" policy_id={this.props.params.policy_id}/>
								...
								<div className="boxBody">
									<div className="row">
										<div className="col-sm-12">
											...
											{ (data && data.components_lr != undefined && data.components_lr.length > 0) ?
											<div className="table-responsive">
												<table className="table table-bordered table-striped table-hover table-box">
													<thead>
														<tr>
												...
												<table className="table table-bordered table-striped table-hover table-box">
													<thead>
														<tr>
															<th className="header_table ">No</th>															
															<th className="header_table ">Product Name</th>
															<th className="header_table ">Area</th>
															<th className="header_table ">Booster</th>
															<th className="header_table ">Prorate</th>
															<th className="header_table ">Co-sharing</th>
															<th className="header_table ">Deductible</th>
														</tr>
													</thead>
													<tbody>     
														{hsr_info_row}               
