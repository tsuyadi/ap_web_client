...
class annual_investment_transaction_report extends React.Component {
	constructor(props){
		super(props);
	...
	getData = (action) => {
		...
		$.ajax({
            url: api_route.policy_annual_investment_transaction_report,
            headers: {
	...
	render(){
		...
		<div className="wrap2">
            ...
            <TopMenuNewBusinessDetail opsi="policyt" title="Annual Investment Transaction Report" />
			...
			<div className="main-wrapper">
				{/*<div className="row">
					<div className="col-xs-10" style={{paddingRight : 0}}>*/}
						<ol className="breadcrumb" style={{marginBottom: '5px'}}>
							...
							<li className="active">Annual Investment Transaction Report</li>
						</ol>
					{/*</div>
				...
				<div className="main twoColumnMain boxShadow">
					...
					<LeftMenuPolicy active="8" policy_id={this.state.policy_id} />
...
export default annual_investment_transaction_report;
