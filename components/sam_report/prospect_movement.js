...
class prospect_movement extends React.Component {
	constructor(props) {
		super(props);
	...
	downloadFile(file) {
		...
		$.ajax({
			...
			success: (response) => {
				...
				FileSaver.saveAs(blob, "Open Case Recruit_" + filename + ext);
			},
			error: (xhr, status) => {
			  $('#loading').modal('hide');
			  if(xhr.status == '401') {
										...
										<div className="col-sm-6">
											<div className="form-horizontal">
												...
												<div className="form-group">
													...
													<div className="col-sm-7">
														<input type="text" className="form-control" id="ProspectName" name="ProspectName" onChange={this.handleChangeData} />
													</div>
												</div>
												<div className="form-group">
													<div className="col-sm-5">
													...
													<div className="col-sm-7">
														<select className="form-control" id="CaseStatus" name="CaseStatus" onChange={this.handleChangeData} >
															<option value="">All</option>
												...
												<div className="form-group">
													...
													<div className="col-sm-7">
														{this.state.list_source != null && this.state.list_source.Source ?
															(
																<select className="form-control" id="Source" name="Source" onChange={this.handleChangeData} >
																	{source_list}
																</select>
															) : (
																<select className="form-control" id="Source" name="Source" onChange={this.handleChangeData} disabled>
																</select>
															)
														}
													</div>
												...
												<div className="form-group">
													...
													<div className="col-sm-3">
														<input type="number" className="form-control c" id="AFYPStart" name="AFYPStart" pattern="[0-9]*" onChange={this.handleChangeData} />
													</div>
													<div className="col-sm-1"> to
											</div>
													<div className="col-sm-3">
														<input type="number" className="form-control" id="AFYPEnd" name="AFYPEnd" pattern="[0-9]*" onChange={this.handleChangeData} />
													</div>
												</div>
												...
												<div className="form-group">
													...
													<div className="col-sm-3">
														<DatePicker className="form-control c" id="ProspectStartDate" name="ProspectStartDate" onChange={this.handleChangeData} />
													</div>
													<div className="col-sm-1"> to
											</div>
													<div className="col-sm-3">
										...
										<div className="col-sm-6">
											<div className="form-horizontal">
												<div className="form-group">
													...
													<div className="col-sm-4">
														<select className="form-control" id="column_1" name="Column" >
															...
															<option value="prospect_createdate">Prospect Create Date</option>
															<option value="approaching_date">Approaching</option>
															<option value="build_trust_meeting_date">Building Trust Meeting</option>
															<option value="discovery_date">Discovery MO.N.E.Y & Agreement</option>
															<option value="design_presentation_date">Desain & Presentation</option>
															<option value="ask_for_commitment_date">Ask for Commitment</option>
															<option value="waiting_payment_date">Waiting Payment</option>
															<option value="case_submit_date">Case Submitted</option>
															<option value="policy_issued_date">Policy Issued</option>
															<option value="policy_delivery_date">Policy Delivery</option>
															<option value="reference_date">Reference</option>
												...
												<div className="form-group">
													...
													<div className="col-sm-4">
														<select className="form-control" id="order_2" name="Order">
															<option value="">-</option>
															<option value="asc">Ascending</option>
															<option value="desc">Descending</option>
														</select>
												...
												<div className="form-group">
													...
													<div className="col-sm-4">
														<select className="form-control" id="order_3" name="Order">
															<option value="">-</option>
															<option value="asc">Ascending</option>
															<option value="desc">Descending</option>
														</select>
...
export default prospect_movement;
