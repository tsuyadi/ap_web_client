...
class sales_prospect_card extends React.Component {
	constructor(props){
		super(props);
        ...
        selling_card_id: getAllUrlParams(window.location.href).id,
      ...
      downloadModalSelling(){
        ...
        $.ajax({
            ...
            success: (response) => {
                ...
                FileSaver.saveAs(blob, "Prospect Card Selling" + localStorage.agent_code + ".pdf");
            },
            error: (err, response) => {
                $('#loading').modal('hide');
			...
			<div className="main-wrapper">
				...
				<div className="main twoColumnMain">
					...
					<div className="main-content boxShadow">
                        <div style={{position: 'absolute',top: '0'}}><h3>Sales Prospect Card</h3></div>                        
                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-12">
                                ...
                                <div className="col-sm-3">
                                    <button className="btn btn-primary btn-block" type="button" onClick={this.getData.bind(this, '0')}><i className="fa fa-search"></i> Search</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="table-responsive" >
                        <table className="table table-bordered table-striped table-hover table-box" id="spc-table" height="100%">
                            ...
                            <tbody id="spc-body">   
                                ...
                                <tfoot>
                                    <tr>
                                        <th colSpan="15"><button style={{marginRight:'10px'}} className="btn btn-primary"  onClick={() => this.downloadModalSelling()}>Download Prospect Card</button><button className="btn btn-primary"  onClick={() => this.downloadModalMoney()}>Download M.O.N.E.Y Analysis</button></th>
                                    </tr>
                                </tfoot>
                        </table>
                            <div>
...
export default sales_prospect_card;
