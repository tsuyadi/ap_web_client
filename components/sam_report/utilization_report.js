...
class utilization_report extends React.Component {
	constructor(props) {
		super(props);
		...
		this.state = {
			...
			param: {
				AgentCode: "80011662",
				Criteria: "Both",
				ProspectSavedStartDate: "",
				ProspectSavedEndDate: "",
				ActivityStartDate: "",
				ActivityEndDate: "",
				ProspectActivityStartDate: "",
				ProspectActivityEndDate: "",
				Page: "1",
				Sort: [
					{ "Column": "", "Order": "" }
				]
	...
	downloadFile(file) {
		...
		$.ajax({
			url: api_route.report_ams_utilization_download,
			headers: {
			...
			success: (response) => {
				...
				FileSaver.saveAs(blob, "AMS Utilization Report_" + filename + ext);
			},
			error: (xhr, status) => {
			  $('#loading').modal('hide');
			  if(xhr.status == '401') {
	...
	componentDidMount() {
		...
		$('#loading').modal('show');
		$.ajax({
			url: api_route.report_ams_utilization,
			headers: {
				'Authorization': 'JWT ' + sessionStorage.getItem('token'),
				'Content-Type': 'application/json',
				'Accept': 'application/json'
			...
			success: (response) => {
				...
				$('#util-report').html(response.result);
			},
			error: (err, response) => {
	...
	getData(param) {
		...
		if (this.state.param.Criteria == 'Both') {
			this.state.param.ProspectActivityStartDate = DateFormatYMDx(document.getElementById('ProspectActivityStartDate').value);
			this.state.param.ProspectActivityEndDate = DateFormatYMDx(document.getElementById('ProspectActivityEndDate').value);
		} else if (this.state.param.Criteria == 'Prospect Saved Date') {
			this.state.param.ProspectSavedStartDate = DateFormatYMDx(document.getElementById('ProspectSavedStartDate').value);
			this.state.param.ProspectSavedEndDate = DateFormatYMDx(document.getElementById('ProspectSavedEndDate').value);
		} else if (this.state.param.Criteria == 'Activity Date') {
			this.state.param.ActivityStartDate = DateFormatYMDx(document.getElementById('ActivityStartDate').value);
			this.state.param.ActivityEndDate = DateFormatYMDx(document.getElementById('ActivityEndDate').value);
		}
		// this.state.param.Sort = sort; 
		console.log(this.state.param);
		this.state.param.Page = '1';
		if ((new Date(this.state.param.ProspectActivityStartDate) <= new Date(this.state.param.ProspectActivityEndDate)) || (new Date(this.state.param.ProspectSavedStartDate) <= new Date(this.state.param.ProspectSavedEndDate)) || (new Date(this.state.param.ActivityStartDate) <= new Date(this.state.param.ActivityEndDate))) {
			$('#loading').modal('show');

			if (this.state.param.Criteria == 'Both') {
				this.state.param.ProspectActivityStartDate = (this.state.param.ProspectActivityStartDate == null) ? '' : this.state.param.ProspectActivityStartDate;
				this.state.param.ProspectActivityEndDate = (this.state.param.ProspectActivityEndDate == null) ? '' : this.state.param.ProspectActivityEndDate;
			} else if (this.state.param.Criteria == 'Prospect Saved Date') {
				this.state.param.ProspectSavedStartDate = (this.state.param.ProspectSavedStartDate == null) ? '' : this.state.param.ProspectSavedStartDate;
				this.state.param.ProspectSavedEndDate = (this.state.param.ProspectSavedEndDate == null) ? '' : this.state.param.ProspectSavedEndDate;
			} else if (this.state.param.Criteria == 'Activity Date') {
				this.state.param.ActivityStartDate = (this.state.param.ActivityStartDate == null) ? '' : this.state.param.ActivityStartDate;
				this.state.param.ActivityEndDate = (this.state.param.ActivityEndDate == null) ? '' : this.state.param.ActivityEndDate;
			}
											...
											<div className="form-horizontal">
												<div className="form-group">
													...
													<div className="col-sm-7">
														<select className="form-control" id="Criteria" name="Criteria" onChange={this.handleChangeData} >
															<option value="Both">Both</option>
															<option value="Prospect Saved Date">Prospect Saved Date</option>
												...
												<div className="form-group">
													<div className="col-sm-5">
														<label>Prospect Saved Date</label>
													</div>
													<div className="col-sm-3">
														{
															(this.state.param.Criteria == 'Prospect Saved Date') ?
																<DatePicker className="form-control c" id="ProspectSavedStartDate" name="ProspectSavedStartDate" onChange={this.handleChangeData} /> :
																<DatePicker className="form-control c" id="ProspectSavedStartDate" name="ProspectSavedStartDate" onChange={this.handleChangeData} value="" disabled />
														}
													</div>
													...
													<div className="col-sm-3">
														{
															(this.state.param.Criteria == 'Prospect Saved Date') ?
																<DatePicker className="form-control c" id="ProspectSavedEndDate" name="ProspectSavedEndDate" onChange={this.handleChangeData} /> :
																<DatePicker className="form-control c" id="ProspectSavedEndDate" name="ProspectSavedEndDate" onChange={this.handleChangeData} value="" disabled />
														}
													</div>
												</div>
												<div className="form-group">
													...
													<div className="col-sm-3">
														{
															(this.state.param.Criteria == 'Activity Date') ?
																<DatePicker className="form-control c" id="ActivityStartDate" name="ActivityStartDate" onChange={this.handleChangeData} /> :
																<DatePicker className="form-control c" id="ActivityStartDate" name="ActivityStartDate" onChange={this.handleChangeData} value="" disabled />
														}
													</div>
													<div className="col-sm-1"> to
											</div>
													<div className="col-sm-3">
														{
															(this.state.param.Criteria == 'Activity Date') ?
																<DatePicker className="form-control c" id="ActivityEndDate" name="ActivityEndDate" onChange={this.handleChangeData} /> :
																<DatePicker className="form-control c" id="ActivityEndDate" name="ActivityEndDate" onChange={this.handleChangeData} value="" disabled />
														}
													</div>
												</div>
												<div className="form-group">
													<div className="col-sm-5">
														<label>Prospect Saved / Activity Date</label>
													</div>
													<div className="col-sm-3">
														{
															(this.state.param.Criteria == 'Both') ?
																<DatePicker className="form-control c" id="ProspectActivityStartDate" name="ProspectActivityStartDate" onChange={this.handleChangeData} /> :
																<DatePicker className="form-control c" id="ProspectActivityStartDate" name="ProspectActivityStartDate" onChange={this.handleChangeData} value="" disabled />
														}
													</div>
													<div className="col-sm-1"> to
											</div>
													<div className="col-sm-3">
														{
															(this.state.param.Criteria == 'Both') ?
																<DatePicker className="form-control c" id="ProspectActivityEndDate" name="ProspectActivityEndDate" onChange={this.handleChangeData} /> :
																<DatePicker className="form-control c" id="ProspectActivityEndDate" name="ProspectActivityEndDate" onChange={this.handleChangeData} value="" disabled />
														}
													</div>
												</div>
											</div>
												...
												<div className="form-group">
													...
													<div className="col-sm-4">
														<select className="form-control" id="column_1" name="Column" >
															...
															<option value="ASH">ASH Name</option>
															<option value="DEVICE_INFO">Device Type</option>
															<option value="COUNT_ACTIVITY"># of Activity</option>
															<option value="COUNT_MEETING"># of Meeting</option>
															<option value="COUNT_CALL"># of Call</option>
															<option value="COUNT_EMAIL"># of Email</option>
															<option value="COUNT_TEXTING"># of Texting</option>
														</select>
													</div>
								...
								<div className="row">
									<div className="col-sm-12">
										<div className="scroll-h" style={{ 'overflow-x': 'auto' }}>
											...
											<div className="col-sm-12" id="util-report">
											</div>
											<div>
												<nav aria-label="Page navigation">
													<ul className="pagination">
...
export default utilization_report;
