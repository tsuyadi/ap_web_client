...
class oc_recruit extends React.Component {
	constructor(props){
		super(props);
			...
			$.map(data, (value, index) => {
				...
				// let url = "#/newbusiness/policy_info/"+value.id;
					...
					<tr key={index}>
						...
						<td>{value.recruit_name == null ? '' : value.recruit_name == null ? '' : value.recruit_name}</td>
						...
						<td>{value.magic_question_date == null ? '' : value.magic_question_date == null ? '' : DateFormatMMM(value.magic_question_date)}</td>
						<td>{value.initial_interview_date == null ? '' : value.initial_interview_date == null ? '' : DateFormatMMM(value.initial_interview_date)}</td>
						<td>{value.initial_assessment_date == null ? '' : value.initial_assessment_date == null ? '' : DateFormatMMM(value.initial_assessment_date)}</td>
						<td>{value.depth_interview_date == null ? '' : value.depth_interview_date == null ? '' : DateFormatMMM(value.depth_interview_date)}</td>
						<td>{value.reference_check_date == null ? '' : value.reference_check_date == null ? '' : DateFormatMMM(value.reference_check_date)}</td>
						<td>{value.offering_letter_date == null ? '' : value.offering_letter_date == null ? '' : DateFormatMMM(value.offering_letter_date)}</td>
						<td>{value.register_date == null ? '' : value.register_date == null ? '' : DateFormatMMM(value.register_date)}</td>
						<td>{value.aaji_license_date == null ? '' : value.aaji_license_date == null ? '' : DateFormatMMM(value.aaji_license_date)}</td>
						<td>{value.training_fast_date == null ? '' : value.training_fast_date == null ? '' : DateFormatMMM(value.training_fast_date)}</td>
									...
									<table className="table table-bordered table-striped table-hover text-center table-box">
										<thead>
											<tr>
												...
												<th className="header_table valign-middle text-center">3 Magic Question/TOD</th>
												<th className="header_table valign-middle text-center">Initial Interview</th>
												<th className="header_table valign-middle text-center">Initial Assessment</th>
												<th className="header_table valign-middle text-center">In-depth Interview</th>
												<th className="header_table valign-middle text-center">VIP Discussion</th>
												<th className="header_table valign-middle text-center">Offering Letter</th>
												<th className="header_table valign-middle text-center">Register Form & Contract</th>
												<th className="header_table valign-middle text-center">AAJI License</th>
												<th className="header_table valign-middle text-center">Training FAST</th>
										...
										<tfoot>
											<tr>
												<th colSpan="22"><button style={{marginRight:'10px'}} className="btn btn-primary" onClick={() => this.downloadRecruit('excel')}>Export as XLSX</button></th>
											</tr>
										</tfoot>
									</table>
									<div>
